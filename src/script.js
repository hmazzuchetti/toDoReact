          ...
          <div className="row">
            <div className="col-12 tasks">
              ...
              <div className="mt-3 filter">
                ...
                <label>
                  <input className="ml-3" type="checkbox" name="active" checked={filter === "active"} onChange={this.toggleFilter} /> Active
                </label>
                <label>
                  <input className="ml-3" type="checkbox" name="completed" checked={filter === "completed"} onChange={this.toggleFilter} /> Completed
                </label>
              </div>
